...
namespace K4WV2_CS_WS_Depth_001
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void depthFrameReader_FrameArrived(DepthFrameReader sender, DepthFrameArrivedEventArgs args)
        {
